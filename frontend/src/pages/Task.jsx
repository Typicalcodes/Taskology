        ...
        <form className='m-auto my-16 max-w-[1000px] bg-white p-8 border-2 shadow-md rounded-md'>
          {loading ? (
            ...
            <>
              ...
              <div className="mb-4">
              <label htmlFor="text" className=" after:ml-0.5 after:text-red-500">Title</label>
              <Input type="title" name="title" id="title" value={formData.title} placeholder="Your title" onChange={handleChange} />
              {fieldError("title")}
            </div>
              <div className="mb-4">
